...
export const RobotIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M12 5L12.01 5.01"></path>
    <path d="M8 15L8.01 15.01"></path>
    <path d="M16 15L16.01 15.01"></path>
  </svg>
);
...
export const PaperclipIcon = ({ className }: { className?: string }) => (
  <svg 
    ...
    strokeLinecap="round" 
    strokeLinejoin="round">
      <path d="m21.44 11.05-9.19 9.19a6.003 6.003 0 1 1-8.49-8.49l9.19-9.19a4.002 4.002 0 0 1 5.66 5.66l-9.2 9.19a2.001 2.001 0 1 1-2.83-2.83l8.49-8.48"/>
  </svg>
);
